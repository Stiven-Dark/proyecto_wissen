...
<?php include'layouts/header.php';?>
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Gestion de Vendedores</h3>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <tbody>
                          <?php 
                            $sql="SELECT id, nombre, apellido, telefono, tipo_venta, estado, creado_en FROM vendedor WHERE estado'1' ";
                            ...
                            foreach($vendedores AS $vendedor)
                            {
                              echo "<tr>";
                                ...
                                echo "<td>{$vendedor['apellido']}</td>";
                                echo "<td>{$vendedor['telefono']}</td>";
                                echo "<td>{$vendedor['tipo_venta']}</td>";
                                echo "<td>{$vendedor['estado']}</td>";
                                echo "<td>{$vendedor['creado_en']}</td>";
                              echo "</tr>";                              
                            };
                          ?>
                        </tbody>
