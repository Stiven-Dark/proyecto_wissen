            ...
            <div class="modal-content">
              <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="modalAgregarTipoDocLabel">
                  <i class="fas fa-plus-circle me-2"></i>Agregar Tipo de Casa
                </h5>
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    <label for="nombreTipoDoc" class="form-label">
                      <i class="fas fa-file-alt me-1"></i>Nombre del Tipo de Casa
                    </label>
                    <input 
                      type="text" 
                      class="form-control" 
                      id="nombreTipoDoc" 
                      name="nombre" 
                      placeholder="Ej: girasol, rosa, esmeralda."
                      required
                      maxlength="100"
                    >
...
<script>
        ...
        $('#formAgregarTipoDoc').on('submit', function(e) {
            ...
            // Envío AJAX
            $.ajax({
                url: 'acciones/tipo_casa/agregar.php',
                type: 'POST',
                dataType: 'json',
                data: {
                    nombre: nombre,
