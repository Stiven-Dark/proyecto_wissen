...
try {
    ...
    $sqlExiste = "SELECT COUNT(*) as total FROM tipo_casa WHERE id = :id";
    ...
    $sqlVerificar = "SELECT COUNT(*) as total FROM tipo_casa 
    ...
    $sqlAnterior = "SELECT nombre, estado FROM tipo_casa WHERE id = :id";
    ...
    $sqlActualizar = "UPDATE tipo_casa
    ...
    if ($stmtActualizar->execute()) {
        ...
        if ($filasAfectadas > 0) {
            ...
            $logMensaje = "Tipo casa actualizado - ID: $id, " .
        ...
        throw new Exception('Error al actualizar el tipo de casa en la base de datos.');
    }
