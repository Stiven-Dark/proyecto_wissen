...
try {
    ...
    $sqlVerificar = "SELECT COUNT(*) as total FROM tipo_documento WHERE LOWER(nombre) = LOWER(:nombre)";
    ...
    if ($resultado['total'] > 0) {
        throw new Exception('Ya existe un tipo de documento con ese nombre.');
    }

    // 6. INSERTAR EN LA BASE DE DATOS
    $sqlInsertar = "INSERT INTO tipo_documento (nombre, estado) VALUES (:nombre, :estado)";
    ...
    if ($stmtInsertar->execute()) {
        ...
        error_log("Tipo de documento creado: ID $idInsertado, Nombre: $nombre");
    ...
    error_log("Error PDO en agregar tipo documento: " . $e->getMessage());
